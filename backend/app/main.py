...
app.add_middleware(CORSMiddleware, allow_origins=["https://farmer-setu.vercel.app","http://localhost:3000","http://127.0.0.1:3000"], allow_credentials=True, allow_methods=["*"], allow_headers=["*"])
