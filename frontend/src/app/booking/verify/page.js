  ...
  return (
    <main className="verify-page">
      <section className="verify-card">
        ...
        <p className="sub">This QR code contains the booking information issued by FarmerSetu.</p>
        ...
        <div className="details">
          ...
          <div><span>Status</span><strong className="status">{booking.status || 'Confirmed'}</strong></div>
        </div>

        <p className="notice">Present this QR at the procurement centre. Booking details can be verified from this page.</p>
...
const styles = `
  ...
  .booking-id{margin:20px 0;background:#f1f8f2;border:1px dashed #bcd9c1;border-radius:10px;padding:13px;text-align:center;color:#087a3e;font-size:14px;font-weight:900;letter-spacing:1px}
