  ...
  return (
    <main className="site-shell">
      <aside className="sidebar">
        <div className="brand">
          <img src="/images/farmer-setu-logo.png" alt="कृषि सेतु logo" />
        </div>

        <nav className="side-nav" aria-label="Main navigation">
          {menuItems.map(([icon, label, href], index) => (
            <Link className={`nav-item ${index === 0 ? 'active' : ''}`} href={href} key={label}>
      ...
      <section className="content-area">
        <header className="topbar">
          ...
          <div className="location">⌖ <strong>Motihari, Bihar</strong> <span>⌄</span></div>
          <div className="top-actions">
            <span className="weather">☀️ <strong>28°C</strong></span>
        ...
        <div className="dashboard">
          <section className="hero">
            ...
            <div className="hero-content">
              ...
              <p className="hero-copy">
                FarmerSetu is a digital platform that connects farmers with procurement
                centres, ensures transparency and fairness, and empowers farmers with smart technology.
              </p>
          ...
          <section className="queue-card" id="queue">
            <div className="queue-header">
              ...
              <Link href="/farmer/queue" className="queue-button">▥ &nbsp; View Queue</Link>
            </div>
            <div className="queue-content">
              <div className="centre-info">
                <div className="centre-placeholder">🏢</div>
                <div>
                  <h3>Motihari Procurement Centre</h3>
                  <p>◷ &nbsp; Estimated Waiting Time</p>
                  <strong className="wait-time">42 mins</strong>
              ...
              <div className="qr-placeholder" aria-label="QR code preview">▦<br /><small>QR</small></div>
            </div>
          </section>
        </div>
      </section>
