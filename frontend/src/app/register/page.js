    ...
    <main className="auth-page register-page">
      <section className="auth-panel auth-brand-panel">
        <Link href="/" className="auth-logo" aria-label="FarmerSetu home">
          <img src="/images/IMG_20260829_104252_707.jpg" alt="FarmerSetu logo" />
        </Link>
        <div className="auth-brand-copy">
          <span className="auth-brand-tag">FARMERSETU • SMART PROCUREMENT</span>
          <h1>Sell your harvest <strong>smarter.</strong></h1>
          <p>Register once, find your nearest procurement centre, book a slot and avoid long waiting lines with FarmerSetu.</p>
          <div className="auth-points">
            <div><b>01</b><span>Easy farmer registration</span></div>
            <div><b>02</b><span>Smart slot and token booking</span></div>
            <div><b>03</b><span>Live queue and payment tracking</span></div>
          </div>
        </div>
      ...
      <section className="auth-panel auth-form-panel">
        <div className="auth-form-wrap register-form-wrap">
          ...
          <div className="auth-heading">
            ...
            <p>Enter your details to start using FarmerSetu smart procurement services.</p>
          </div>
      ...
      <style jsx global>{`
        ...
        .register-page .auth-logo{
          width:250px;height:145px;padding:0;border-radius:0;background:transparent;box-shadow:none;overflow:visible;display:flex;align-items:center;justify-content:flex-start;position:relative;z-index:3;
        }
        ...
        .register-page .auth-brand-panel:before,.login-page .auth-brand-panel:before{content:'';position:absolute;inset:0;background:radial-gradient(circle at 15% 75%,rgba(255,255,255,.12),transparent 30%);pointer-events:none;}
        ...
        @media(max-width:900px){
          ...
          .register-page .auth-logo{width:220px;height:125px;}
        ...
        @media(max-width:680px){
          ...
          .register-page .auth-logo{width:175px;height:100px;}
